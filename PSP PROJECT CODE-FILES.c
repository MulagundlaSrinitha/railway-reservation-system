...
{ 
	...
	aread();
	printf("\n\t\t RAILWAY RESERVATION SYSTEM");
	printf("\n\n\nSI\ttrainnumber\ttrainname\t\tstartplace\tdestination place\tprice\tseat\ttime\n\n"); 
	for(i=0;i<k;i++){
...
void awrite()
{
    FILE *train_details; train_details = 
	fopen("train_details.txt","w"); 
